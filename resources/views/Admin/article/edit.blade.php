...
@section('content')
        ...
        <div class="col-12">
            ...
            <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                <ol class="breadcrumb pt-0">
                    <li class="breadcrumb-item"><a href="{{route('article.index')}}">فهرست</a></li>
                    <li class="breadcrumb-item"><a href="{{route('article.create')}}">جدید</a></li>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-body">
                    {{Form::model($article, ['route' => ['article.update',$article->id], 'class'=> 'form-horizontal text-right', 'method' => 'PATCH' ])}}
